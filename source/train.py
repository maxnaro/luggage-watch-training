...
def main():
    ...
    ap.add_argument("--lrf", type=float, default=0.01, help="Final learning rate")
    ap.add_argument("--warmup-epochs", type=float, default=3.0, help="Warmup epochs")
    ap.add_argument("--freeze", type=int, default=10, help="Freeze backbone layers")
    ap.add_argument("--workers", type=int, default=8, help="Dataloader workers")
    ap.add_argument("--cache", default="", help="Cache mode (True, False, 'disk')")
